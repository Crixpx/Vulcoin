...
# Project:  VulCoin.pro
# Template: app
# Command: /usr/lib/x86_64-linux-gnu/qt5/bin/qmake -o Makefile VulCoin.pro
#############################################################################
...
CC            = gcc
CXX           = g++
DEFINES       = -DENABLE_WALLET -DBOOST_THREAD_USE_LIB -DBOOST_SPIRIT_THREADSAFE -DQT_DISABLE_DEPRECATED_BEFORE=0 -DUSE_DBUS -DHAVE_BUILD_INFO -DLINUX -DQT_NO_DEBUG -DQT_PRINTSUPPORT_LIB -DQT_WIDGETS_LIB -DQT_GUI_LIB -DQT_NETWORK_LIB -DQT_DBUS_LIB -DQT_CORE_LIB
...
TAR           = tar -cf
COMPRESS      = gzip -9f
DISTNAME      = VulCoin-qt1.2.0.0
DISTDIR = /root/VulCoinwe/build/VulCoin-qt1.2.0.0
LINK          = g++
LFLAGS        = -m64 -fstack-protector-all --param ssp-buffer-size=1 -Wl,-O1
LIBS          = $(SUBLIBS) -L/usr/X11R6/lib64 /root/VulCoinwe/src/leveldb/libleveldb.a /root/VulCoinwe/src/leveldb/libmemenv.a -L/usr/local/lib -lssl -lcrypto -ldb_cxx -lboost_system -lboost_filesystem -lboost_program_options -lboost_thread -lrt -ldl -lQt5PrintSupport -lQt5Widgets -lQt5Gui -lQt5Network -lQt5DBus -lQt5Core -lpthread -lGL 
AR            = ar cqs
RANLIB        = 
SED           = sed
STRIP         = strip
...
DIST          = /usr/lib/x86_64-linux-gnu/qt5/mkspecs/features/spec_pre.prf \
		...
		VulCoin.pro src/qt/bitcoingui.h \
...
clean: compiler_clean 
	-$(DEL_FILE) $(OBJECTS)
	-$(DEL_FILE) /root/VulCoinwe/src/leveldb/libleveldb.a; cd /root/VulCoinwe/src/leveldb ; $(MAKE) clean
	-$(DEL_FILE) *~ core *.core
...
/root/VulCoinwe/src/leveldb/libleveldb.a: FORCE
	cd /root/VulCoinwe/src/leveldb && CC=gcc CXX=g++ $(MAKE) OPT="-fpermissive -fstack-protector-all --param ssp-buffer-size=1 -O2" libleveldb.a libmemenv.a

/root/VulCoinwe/build/build.h: FORCE
	cd /root/VulCoinwe; /bin/sh share/genbuild.sh /root/VulCoinwe/build/build.h
...
qrc_bitcoin.cpp: src/qt/bitcoin.qrc \
		...
		src/qt/res/icons/VulCoin-80.png \
		...
		src/qt/res/icons/VulCoin-16.png \
...
build/moc_bitcoingui.cpp: src/qt/bitcoingui.h
	/usr/lib/x86_64-linux-gnu/qt5/bin/moc $(DEFINES) -I/usr/lib/x86_64-linux-gnu/qt5/mkspecs/linux-g++-64 -I/root/VulCoinwe -I/root/VulCoinwe/src -I/root/VulCoinwe/src/json -I/root/VulCoinwe/src/qt -I/root/VulCoinwe/src/qt/plugins/mrichtexteditor -I/root/VulCoinwe/src/leveldb/include -I/root/VulCoinwe/src/leveldb/helpers -I/usr/local/include -I/usr/include/x86_64-linux-gnu/qt5 -I/usr/include/x86_64-linux-gnu/qt5/QtPrintSupport -I/usr/include/x86_64-linux-gnu/qt5/QtWidgets -I/usr/include/x86_64-linux-gnu/qt5/QtGui -I/usr/include/x86_64-linux-gnu/qt5/QtNetwork -I/usr/include/x86_64-linux-gnu/qt5/QtDBus -I/usr/include/x86_64-linux-gnu/qt5/QtCore -I/usr/include/c++/5 -I/usr/include/x86_64-linux-gnu/c++/5 -I/usr/include/c++/5/backward -I/usr/lib/gcc/x86_64-linux-gnu/5/include -I/usr/local/include -I/usr/lib/gcc/x86_64-linux-gnu/5/include-fixed -I/usr/include/x86_64-linux-gnu -I/usr/include src/qt/bitcoingui.h -o build/moc_bitcoingui.cpp
