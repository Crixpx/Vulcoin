...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: VulCoin.conf)") + "\n";
    ...
    strUsage += "  -port=<port>           " + _("Listen for connections on <port> (default: 43211 or testnet: 3242)") + "\n";
    ...
    strUsage += "  -rpcport=<port>        " + _("Listen for JSON-RPC connections on <port> (default: 43211 or testnet: 3243)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeVulCoinamount=<n> " + _("Keep N VulCoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. VulCoin is probably already running."), strDataDir));
    ...
    nAnonymizeVulCoinAmount = GetArg("-anonymizeVulCoinamount", 0);
    if(nAnonymizeVulCoinAmount > 999999) nAnonymizeVulCoinAmount = 999999;
    if(nAnonymizeVulCoinAmount < 2) nAnonymizeVulCoinAmount = 2;
    ...
    if(fEnableInstantX){
        ...
        if(nInstantXDepth < 0) nAnonymizeVulCoinAmount = 0;
    } else {
        nInstantXDepth = 0;
    }
    ...
    LogPrintf("Anonymize VulCoin Amount %d\n", nAnonymizeVulCoinAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1VulCoin+1000 == (.1VulCoin+100)*10
       10VulCoin+10000 == (1VulCoin+1000)*10
    */
