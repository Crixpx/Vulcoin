...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeVulCoinAmount"))
        settings.setValue("nAnonymizeVulCoinAmount", 1000);

    nDarksendRounds = settings.value("nDarksendRounds").toLongLong();
    nAnonymizeVulCoinAmount = settings.value("nAnonymizeVulCoinAmount").toLongLong();
    ...
    if (settings.contains("nAnonymizeVulCoinAmount"))
        SoftSetArg("-anonymizeVulCoinamount", settings.value("nAnonymizeVulCoinAmount").toString().toStdString());
}
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case anonymizeVulCoinAmount:
            nAnonymizeVulCoinAmount = value.toInt();
            settings.setValue("nAnonymizeVulCoinAmount", nAnonymizeVulCoinAmount);
            emit anonymizeVulCoinAmountChanged(nAnonymizeVulCoinAmount);
            break;
        default:
            break;
        }
