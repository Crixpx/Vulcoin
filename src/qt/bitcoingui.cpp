...
#endif
    setObjectName("VulCoin");
    setStyleSheet("#VulCoin { background-color: #f9f9f9);  }"
...
void BitcoinGUI::createActions()
{
    ...
    masternodeManagerAction->setToolTip(tr("Show VulCoin Nodes status and configure your nodes."));
    ...
    aboutAction = new QAction(tr("&About VulCoin"), this);
