...
public:
    ...
    void setupUi(QWidget *MasternodeManager)
    {
        ...
        countLabel->setMinimumWidth(140);
        countLabel->setMaximumWidth(140);
        ...
        horizontalLayout_4->setDirection(QBoxLayout::RightToLeft);
    ...
    void retranslateUi(QWidget *MasternodeManager)
    {
        ...
        label_2->setText(QApplication::translate("MasternodeManager", "VulCoin Nodes Count:", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab), QApplication::translate("MasternodeManager", "MoneyBag Nodes Network", 0));
        ...
        tabWidget->setTabText(tabWidget->indexOf(tab_2), QApplication::translate("MasternodeManager", "My MoneyBag Nodes", 0));
    } // retranslateUi
