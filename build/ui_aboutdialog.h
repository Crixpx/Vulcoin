...
public:
    ...
    {
        AboutDialog->setWindowTitle(QApplication::translate("AboutDialog", "About VulCoin", 0));
        label->setText(QApplication::translate("AboutDialog", "<b>VulCoin</b> version", 0));
...
"Copyright \302\251 2017 The VulCoin developers", 0));
