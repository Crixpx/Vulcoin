...
public:
    ...
    {
        AdrenalineNodeConfigDialog->setWindowTitle(QApplication::translate("AdrenalineNodeConfigDialog", "VulCoin Node Configuration Template", 0));
#ifndef QT_NO_TOOLTIP
        detailText->setToolTip(QApplication::translate("AdrenalineNodeConfigDialog", "<html><head/><body><p>This pane shows an example VulCoin.conf template with the necessary masternode settings.</p></body></html>", 0));
#endif // QT_NO_TOOLTIP
    } // retranslateUi
