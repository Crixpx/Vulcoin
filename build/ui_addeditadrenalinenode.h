...
public:
    ...
    {
        AddEditAdrenalineNode->setWindowTitle(QApplication::translate("AddEditAdrenalineNode", "Add/Edit VulCoin Node", 0));
        label_3->setText(QApplication::translate("AddEditAdrenalineNode", "<html><head/><body><p>1) Synchronized your local wallet. <br/>2) In the Alias field, write any name your MoneyBagNode.<br/>3) In the Address field, your external IP address : port P2P (default 43210) click OK. <br/>4) Click button \342\200\234Copy address\342\200\234 and Send to the address received 30000 VCN. <br/>5) Click button \342\200\234Get Config\342\200\235 and copy the contents. <br/>6) Create a file named VulCoin.Conf (C:\\Users\\User\\Appdata\\Roaming\\VulCoin) <br/>7) Replace the rpcuser, rpcpass and port field. <br/>8) Restart the wallet and press button \342\200\235Start\342\200\235 your MoneyBagNode .</p></body></html>", 0));
